...
#read image
image = cv2.imread('I:/Brain_Tumor/skull strip-good ones/458.jpg',0)
#image2 = image.copy()
...
if image_plane == "sagittal":
    erosion = cv2.erode(th1, kernel, iterations = 11)
else:
...
if image_plane == "sagittal":
    mask = cv2.dilate(mask1,kernel,iterations = 14)
else:
...
img = io.imread("I:/Brain_Tumor/skull strip-good ones/458.jpg")
